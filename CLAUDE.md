...
- **Tech Health Pack add-on:** $150 CAD/month, toggle on Starter / Core / Growth, bundled in Agency. Covers GSC indexation monitoring, automatic reindex of the monthly blog posts we ship (4/6/8/12 per tier), crawl errors weekly sweep, broken links monitoring, Core Web Vitals alerts. Sales angle: "the blog posts we publish each month don't get indexed by Google by default; without this pack they sit in 'Discovered, currently not indexed' for weeks. With the pack, every new page is verified indexed within days."
- **GSC Indexation Audit (one-time add-on):** priced by site size. 1-9 pages $100, 10-19 pages $200, 20-29 pages $300, 30-39 pages $400, 40-74 pages $500, 75-99 pages $600, 100-149 pages $800, 150+ pages custom quote. Bundled at signup in Agency. Deliverable: GSC connection + full coverage audit + re-submission of valid URLs + before/after coverage report PDF + canonical/redirect/noindex recommendations. Pairs with the Tech Health Pack for ongoing monitoring after the one-time pass.
- **Agency tier exclusive (vs add-on):** multi-location dashboard, white-label PDF reports, Slack SLA <4h business hours, API access (Share of Model / AI Traffic / Visibility scores), custom integrations (HubSpot, Salesforce, hospitality PMS), quarterly executive deck presented in person, dedicated senior strategist, daily AI Visibility probes (vs weekly Growth), 12 GBP posts/mo + 12 photos/mo per domain, Domain Shield + Domain Speed Boost.
- **CANONICAL UNITS PER TIER (source of truth: `/forfaits-complets` via `src/data/tier-comparison.ts`).** Every blog post, doc, prompt, and chat surface MUST use these exact numbers. Do not invent or carry over older cadences.
  - **GBP posts/mo (single quota, applies whether AiLys publishes on the client's behalf or the client publishes themselves via the dashboard):** Starter 4, Core 6, Growth 8, Agency 12. Client can choose to publish each post themselves; the monthly quota does not change.
  - **GBP photos/mo:** Starter 4, Core 6, Growth 8, Agency 12 per domain.
  - **GBP Q&A monitoring:** Starter weekly, Core twice/week, Growth daily, Agency daily multi-location.
  - **Citations submitted/mo (max per domain):** Starter 2, Core 4, Growth 6, Agency 8.
  - **NAP consistency audit:** Starter quarterly, Core monthly, Growth bi-weekly, Agency weekly.
  - **AI Visibility probes:** Starter monthly, Core weekly, Growth weekly, Agency daily.
  - **Bilingual blog posts (unique topics, EN+FR)/mo:** Starter 2, Core 4, Growth 6, Agency 8 max per domain.
  - **Strategist hours/mo:** Starter ~1h, Core ~3h, Growth ~6h, Agency 12-15h.
  - **Slack SLA (business hours):** Starter email only, Core 48h, Growth 24h, Agency under 4h.
  - **Multi-location dashboard:** Starter no, Core no, Growth up to 3, Agency unlimited.
  - **Schema layers:** Starter LocalBusiness+FAQPage, Core +Service+Review, Growth +HowTo+Person, Agency all+custom JSON-LD.
  - **Reviuzy reputation suite (NFC, AI review gen, fake review detection, contest engine):** Starter/Core/Growth +$100/mo add-on, Agency bundled.
  - **Domain Shield (DNS+WAF):** Starter/Core/Growth +$35/mo add-on, Agency bundled.
