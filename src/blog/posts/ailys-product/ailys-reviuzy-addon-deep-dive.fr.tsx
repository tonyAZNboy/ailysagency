...
export const metaFr: BlogPostMeta = {
  ...meta,
  title: 'Module Reviuzy AiLys, ce que 100 dollars par mois vous donnent',
  metaDescription:
    "Tour complet du module Reviuzy d'AiLys à 100 dollars CAD par mois. Cartes NFC, réponses IA, moteur de concours, générateur légal, détection de faux avis, automatisation GBP.",
  tldr: "Le module Reviuzy se greffe à n'importe quel forfait AiLys pour 100 dollars CAD par mois, et il est inclus dans le forfait Agency. La portée couvre les cartes NFC de collecte d'avis, la génération IA d'avis et de réponses, un moteur de concours avec tirage vidéo, un générateur de termes légaux selon la juridiction, la détection de faux avis et l'ensemble d'automatisation GBP (photos, questions-réponses, attributs). Le client opère son propre concours via l'app Reviuzy. AiLys livre uniquement la configuration, les documents légaux et les guides d'aide.",
  faqItems: [
    {
  ...
  headings: [
    { id: 'ce-qu-est-vraiment-le-module-reviuzy', text: "Ce qu'est vraiment le module Reviuzy" },
...
export function ContentFr() {
  return (
    <article>
      ...
      <h2 id="ce-qu-est-vraiment-le-module-reviuzy">Ce qu'est vraiment le module Reviuzy</h2>
      <p>
        Reviuzy est le SaaS d'AiLys pour la réputation. Il fonctionne aux côtés du moteur AI Visibility et du travail GBP (voir l'<InternalLink to="/glossary/gbp" title="Entrée glossaire GBP" description="Google Business Profile et signaux de classement associés" /> pour la surface sous-jacente), et c'est le seul module AiLys qui livre sa propre app mobile. L'app est sur le téléphone du client pour deux raisons. Premièrement, les taps sur les cartes NFC et les inscriptions au concours arrivent sur l'appareil du client, pas sur celui de l'agence. Deuxièmement, les photos viennent de la caméra du client avec de vraies données EXIF, dont le module GBP a besoin pour bien noter le signal de fraîcheur.
      </p>
      <p>
      ...
      <h3>À quoi ressemble chaque palier avec Reviuzy</h3>
      <ul>
      ...
      <QuickQuiz
        ...
        question="À quel forfait AiLys le module Reviuzy est-il inclus sans frais supplémentaires?"
        options={[
      ...
      <img
        src={meta.images.mid}
        alt="Tableau de bord du moteur de concours Reviuzy avec animation de tirage vidéo et exportation de la liste de participants"
      ...
      <img
        src={meta.images.end}
        alt="Carte complète des modules Reviuzy avec NFC, réponses IA, moteur de concours, générateur légal, détection de faux avis et automatisation GBP"
        className="w-full rounded-xl my-6"
        loading="lazy"
      />
    </article>
