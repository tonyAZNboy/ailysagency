  ...
  return (
    <article>
      ...
      <ul>
        ...
        <li>Agency à 2 500 dollars : AiLys Automation est inclus, multi-emplacements et marque blanche compris, stratège dédié, rapports hebdomadaires</li>
      </ul>
