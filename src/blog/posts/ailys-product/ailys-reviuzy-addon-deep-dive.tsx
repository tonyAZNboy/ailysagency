...
export const meta: BlogPostMeta = {
  ...
  headings: [
    { id: 'what-the-reviuzy-add-on-actually-is', text: 'What the Reviuzy add-on actually is' },
...
export function Content() {
  return (
    <article>
      ...
      <h3>What each tier looks like with Reviuzy</h3>
      <ul>
      ...
      <p>
        The NFC cards are the physical surface of the add-on. They sit on the counter, the pin pad, the reception desk, or the take-out bag. A customer taps the card with their phone, the phone opens a Reviuzy landing page, and the page routes the customer to the Google Business Profile review form for the right location. No app install. No QR scan. Just a tap.
      </p>
      <p>
      ...
      <p>
        The contest engine is the strongest module for review velocity. The owner sets up a draw inside the dashboard, defines the prize, the duration, and the entry rules, and the engine wires up the entry capture. Customers enter the contest by tapping the NFC card, optionally leaving a Google review, and confirming the entry on the Reviuzy app. The entry list is held inside the client account, not the agency account.
      </p>
      <p>
      ...
      <img
        src={meta.images.mid}
        alt="Reviuzy contest engine dashboard with video winner picker animation and entry list export"
      ...
      <img
        src={meta.images.end}
        alt="Reviuzy add-on full module map with NFC, AI replies, contest engine, legal generator, fake detection, and GBP automation"
        className="w-full rounded-xl my-6"
        loading="lazy"
      />
    </article>
