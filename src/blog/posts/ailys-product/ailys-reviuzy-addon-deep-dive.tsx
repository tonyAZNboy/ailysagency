...
export function Content() {
  return (
    <article>
      ...
      <p>
        The review generation side helps customers who tap the NFC card but freeze at the blank review form. The flow runs in three steps. First the landing page surfaces a short bullet list of "what did you like?" prompts (food quality, speed of service, staff name, ambiance, value, specific dish, etc.) keyed to the business category, and the customer taps the bullets that match the experience. Then the AI generates three full review drafts based on the picked bullets, each with a different voice and length. Then the customer picks the one that sounds most like them and the page hands off to the GBP review form with the text already pasted, ready to submit in one click. The whole flow runs in under thirty seconds from tap to submit, which is why high-traffic locations realistically reach 4-6 fresh reviews per week (the ceiling depends on counter foot traffic, NFC card placement, and staff prompting).
      </p>
