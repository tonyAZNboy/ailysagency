  ...
  return (
    <article>
      ...
      <ol>
        ...
        <li>Le livrable est de la formation corporative, de la gestion du changement ou du renforcement de capacites à l'intérieur de l'organisation. AiLys livre une sortie AI Visibility, pas des programmes de capacites internes.</li>
      </ol>
