...
export function ContentFr() {
  return (
    <article>
      ...
      <p>
        Digitad est une agence de marketing numerique basee a Montréal, fondee en 2017. La portée est large : SEO, Google Ads, Meta Ads, gestion de réseaux sociaux, stratégie de contenu, courriel marketing et développement web. L'équipe fonctionne principalement en français avec capacite anglaise, et les tarifs sont sur devis par engagement.
      </p>
      <p>
