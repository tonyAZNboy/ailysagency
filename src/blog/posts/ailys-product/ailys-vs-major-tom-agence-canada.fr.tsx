...
export const metaFr: BlogPostMeta = {
  ...
  faqItems: [
    {
      question: 'Comment AiLys se comparé-t-elle a Major Tom pour les commerces locaux au Canada?',
      answer:
