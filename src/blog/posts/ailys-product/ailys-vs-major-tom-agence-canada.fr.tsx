...
export function ContentFr() {
  return (
    <article>
      <p>
        Les proprietaires d'entreprises canadiens qui comparent les agences numeriques finissent par tomber sur Major Tom et AiLys. Les deux servent des profils d'opérateurs fondamentalement différents, et les comparer tete a tete revient a comparer une ligne aerienne nationale a une navette régionale. Les deux vous amenent quelque part, mais les cartes de routes ne se chevauchent pas. Cette page detaille les différences sur la portée, les tarifs, la geographie et la livraison bilingue.
      </p>
      ...
      <p>
        AiLys est une plateforme d'AI Visibility batie au Québec avec quatre forfaits mensuels a prix fixe. La portée est la recherche locale : audits AI Visibility sur les principaux moteurs IA, optimisation GBP, travail de citations NAP, couches de schemas, pages FAQ et automatisation de reputation via le module Reviuzy. La clientele est composee de commerces de service locaux a travers le Québec et le Canada.
      </p>
      <p>
        Major Tom construit des marques. AiLys construit de la présence en recherche locale. Les deux resolvent des problèmes différents a des prix différents pour des tailles d'opérateurs différentes. Un dentiste a Laval et une marque e-commerce nationale a Vancouver ne sont pas dans le même cycle d'achat, et aucun des deux ne devrait utiliser l'agence de l'autre.
      </p>
      ...
      <p>
        AiLys publié quatre forfaits avec des listes de livrables fixes. Starter a 300 dollars CAD, Core a 600 dollars, Growth a 1 200 dollars, Agency a 2 499 dollars. Chaque palier livre un ensemble défini de livrables chaque mois, sans facturation a l'heure, sans derive de portée.
      </p>
      <p>
      ...
      <QuickQuiz
        ...
        correctIndex={1}
        explanation="Major Tom sert les marques de taille moyenne et les entreprises qui ont besoin de stratégie numerique complete incluant créatif, développement et campagnes nationales. AiLys sert les opérateurs locaux qui ont besoin d'AI Visibility, GBP et citations a un cout mensuel fixe."
      />
      ...
      <p>
        La distinction compte pour les opérateurs qui ont déjà perdu de l'AI Visibility face aux concurrents. Si le concurrent apparait dans ChatGPT et vous non, une agence a service complet finira par aider a travers l'amélioration SEO générale. AiLys aidera plus vite parce qu'elle mesure et cible le resultat spécifique.
      </p>
      ...
      <p>
        Major Tom a son siege a Vancouver avec un bureau a New York. L'agence sert les clients canadiens a l'échelle nationale en anglais. La livraison de contenu en francais québécois peut impliquer des flux de traduction ou de la sous-traitance, ce qui est standard pour les agences basees hors du Québec.
      </p>
      <p>
        AiLys est batie au Québec et livre chaque livrable bilingue EN et FR-CA a l'interne. Articles de blogue, publications GBP, reecritures de citations, contenu FAQ, livrables d'audit et l'interface de la plateforme. Le flux utilise EN canonique d'abord, FR-CA rédigé a la main ensuite par une personne bilingue. Aucune API de traduction. Le francais québécois avec ses idiomes régionaux est preserve.
      </p>
      <p>
      ...
      <ol>
        <li>Le commerce a besoin d'une stratégie de marque lourde et d'une production créative au-delà de ce qui est inclus avec AiLys. La construction de site web est incluse dans chaque forfait AiLys (avec une clause de recuperation des frais de création si le contrat est annule avant 6 mois), mais les campagnes de marque d'entreprise et la production créative originale a grande échelle vont a une agence a service complet comme Major Tom.</li>
      ...
      <CalloutBox type="warning" translatedLabel="Attention">
        <p>Evitez d'engager une agence d'entreprise pour un problème local. Un commerce de service a un seul emplacement qui a besoin d'AI Visibility et de travail GBP va surpayer a des tarifs d'entreprise et attendre plus longtemps pour des livrables concus pour une échelle différente. Associez l'agence au problème, pas au prestige.</p>
      </CalloutBox>
      ...
      <KeyTakeaway
        ...
        points={[
          "Major Tom est une agence numerique pancanadienne a service complet pour les marques de taille moyenne et les entreprises. AiLys est une plateforme spécialisée d'AI Visibility pour les commercants locaux.",
          'Les forfaits AiLys vont de 300 a 2 499 dollars CAD avec portée fixe. Les retainers Major Tom sont sur devis a l\'échelle d\'entreprise.',
          "Major Tom livre stratégie, créatif, développement, media payant et SEO a l'échelle nationale. AiLys livre AI Visibility, GBP et citations localement.",
