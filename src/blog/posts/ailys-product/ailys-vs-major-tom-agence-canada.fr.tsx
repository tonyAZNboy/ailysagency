...
export const metaFr: BlogPostMeta = {
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer:
        "Major Tom a son siege a Vancouver avec un bureau a New York. L'agence sert les clients canadiens à l'échelle nationale mais l'équipe fonctionne principalement en anglais. La livraison de contenu en français québécois peut exiger des flux de traduction ou de la sous-traitance. AiLys livre chaque livrable bilingue EN et FR-CA à l'interne, avec du français québécois rédigé à la main et aucune API de traduction. Pour les opérateurs québécois qui ont besoin de contenu natif en français, c'est une distinction significative.",
    },
    {
...
export function ContentFr() {
  return (
    <article>
      ...
      <p>
        Major Tom a son siege a Vancouver avec un bureau a New York. L'agence sert les clients canadiens à l'échelle nationale en anglais. La livraison de contenu en français québécois peut impliquer des flux de traduction ou de la sous-traitance, ce qui est standard pour les agences basees hors du Québec.
      </p>
      <p>
