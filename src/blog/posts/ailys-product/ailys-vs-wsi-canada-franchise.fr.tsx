...
export const metaFr: BlogPostMeta = {
  ...
  faqItems: [
    {
      question: 'Comment AiLys se comparé-t-elle a WSI pour les commerces locaux canadiens?',
      answer:
        "AiLys est une plateforme d'AI Visibility bâtie au Québec avec quatre forfaits CAD publiés (300 à 2 499 dollars), livraison bilingue EN et FR-CA à l'interne et un audit gratuit en 24 heures. WSI est une franchise mondiale de marketing numérique fondée a Toronto en 1995, avec des consultants operant dans plus de 80 pays qui livrent du SEO, du media payant, du social, de la conception web et du conseil IA aux PME locales. AiLys est une seule équipe avec une plateforme livrant des livrables coherents à travers les paliers. WSI est un réseau de consultants independants, chacun avec sa propre portée, tarification et specialisation.",
    },
    {
...
export function ContentFr() {
  return (
    <article>
      ...
      <p>
        Deux questions tranchent. Premierement, voulez-vous un seul consultant nomme qui agit comme votre partenaire de marketing numérique a long terme sur tous les canaux, ou une plateforme qui livre des livrables AI Visibility coherents chaque mois? La relation consultant est WSI. Le modèle plateforme est AiLys. Deuxiemement, votre problème principal est-il l'exécution AI Visibility ou le marketing numérique a service complet? L'AI Visibility specifiquement va a AiLys. Le service complet à travers SEO, payant, social, web et conseil IA va à un consultant WSI ou agence comparable.
      </p>
      <p>
