  ...
  faqItems: [
    {
      ...
      answer:
        "AiLys est une plateforme d'AI Visibility bâtie au Québec avec quatre forfaits CAD publiés (300 à 2 499 dollars), livraison bilingue EN et FR-CA à l'interne et un audit gratuit en 24 heures. WSI est une franchise mondiale de marketing numerique fondee a Toronto en 1995, avec des consultants operant dans plus de 80 pays qui livrent du SEO, du media payant, du social, de la conception web et du conseil IA aux PME locales. AiLys est une seule équipe avec une plateforme livrant des livrables coherents à travers les paliers. WSI est un réseau de consultants independants, chacun avec sa propre portée, tarification et specialisation.",
    },
    {
      question: 'WSI est-elle une seule agence ou un réseau de franchises?',
      answer:
        "WSI fonctionne sur un modèle de réseau franchise/consultant. Chaque consultant WSI gère son propre territoire et sa liste de clients, soutenu par la marque centrale WSI pour la formation, la methodologie et les outils. L'expérience pour un opérateur qui engage WSI depend fortement du consultant avec lequel il se connecte : la portée, la tarification, la capacite linguistique et la specialisation varient selon le consultant. AiLys est une seule équipe avec une tarification et des livrables coherents à travers chaque palier et chaque client.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Les consultants WSI au Québec ou dans l'Est du Canada peuvent fonctionner bilingue, mais la capacite bilingue depend entierement du consultant individuel choisi. AiLys livre chaque livrable bilingue EN et FR-CA à l'interne par defaut, avec du français québécois rédigé à la main (courriel, magasiner, fin de semaine) et aucune API de traduction a aucune etape. La distinction AiLys est la livraison bilingue coherente à travers chaque palier et chaque client, pas dependante du consultant.",
    },
    {
  ...
  return (
    <article>
      ...
      <KeyTakeaway
        ...
        points={[
          "WSI a été fondee a Toronto en 1995 et fonctionne comme un réseau mondial de franchises de consultants dans 80+ pays. AiLys est une plateforme d'AI Visibility bâtie au Québec avec une seule équipe et une plateforme publiée.",
