  ...
  return (
    <article>
      <img
        ...
        alt="Calendrier de publications Google Business Profile montrant une cadence hebdomadaire pour un commerce local du Québec"
