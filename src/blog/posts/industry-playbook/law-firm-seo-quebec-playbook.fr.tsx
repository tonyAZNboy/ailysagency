...
export function ContentFr() {
  return (
    <article>
      ...
      <p>
        Les Google AI Overviews sur les requêtes juridiques citent différemment des requêtes commerce. Le seuil de confiance est plus haut, donc les AI Overviews tendent à citer d'abord les annuaires (Barreau, Lexology, JuriBistro) puis les pages de cabinets individuelles. Un cabinet gagne la citation de second rang en étant le meilleur appariement côté annuaire, pas en écrivant le plus long billet de blogue. Perplexity se comporte de façon similaire avec un penchant un peu plus fort pour Wikipédia et les sources gouvernementales sur les questions de procédure.
      </p>
      <p>
