...
export const metaFr: BlogPostMeta = {
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer:
        "Le client opère le concours. Reviuzy fournit la configuration, le générateur de termes et conditions juridiques, les guides d'aide et le tableau de bord pour tirer le gagnant. Le client est propriétaire du prix, de la relation client et de toute divulgation fiscale ou réglementaire qui s'applique dans sa juridiction. AiLys ne tire pas le gagnant et ne communique pas avec les concurrents. Cette séparation garde l'agence du bon côté des règles de concours au Québec et au Canada.",
    },
    {
      question: "Qui téléverse les photos quand un gagnant de concours est annoncé?",
      answer:
        "Le client téléverse les photos via l'application Reviuzy. AiLys ne fournit pas les photos de gagnant et ne téléverse pas au GBP au nom du concours. L'application Reviuzy fournit le formulaire de téléversement, la capture de consentement et la poussée vers le GBP, mais l'action humaine reste chez l'opérateur. Cela protège le client des enjeux de droits d'auteur et garde la provenance photo propre pour Google.",
    },
    {
      question: "Comment Reviuzy détecte-t-il les avis bidons et que fait-il avec?",
      answer:
        "Le détecteur d'avis bidons de Reviuzy évalue chaque nouvel avis sur quelques signaux : âge du compte, schéma d'historique d'avis, probabilité d'écriture par modèle de langage et proximité de grappe IP. Les avis signalés au-dessus du seuil sont remontés dans le tableau de bord avec une action « signaler à Google » en un clic. Le système ne signale pas automatiquement sans approbation du propriétaire, parce que Google pénalise les faux positifs. Le propriétaire décide quels signalements pousser à Google.",
    },
    {
      question: "Les réponses automatisées sont-elles sûres ou Google pénalise-t-il les réponses gabarit?",
      answer:
        "Les réponses automatisées sont sûres quand elles sont personnalisées par avis. Reviuzy génère un brouillon adapté au texte de l'avis, au prénom du commentateur et au service mentionné. Le propriétaire approuve ou édite le brouillon en un clic, et la réponse part au GBP via l'API officielle Google. Les réponses gabarit identiques sur plusieurs avis déclenchent la détection de schémas et peuvent provoquer une suppression douce de la fiche. La convention Reviuzy est un brouillon approuvé par avis, jamais un copier-coller.",
    },
  ],
  headings: [
    { id: 'ce-qu-est-reviuzy-et-ce-qu-il-n-est-pas', text: "Ce qu'est Reviuzy et ce qu'il n'est pas" },
    ...
    { id: 'comment-reviuzy-se-branche-au-gbp-et-au-moteur-ailys', text: 'Comment Reviuzy se branche au GBP et au moteur AiLys' },
    { id: 'quand-reviuzy-se-rentabilise', text: 'Quand Reviuzy se rentabilise' },
...
export function ContentFr() {
  return (
    <article>
      ...
      <h2 id="ce-qu-est-reviuzy-et-ce-qu-il-n-est-pas">Ce qu'est Reviuzy et ce qu'il n'est pas</h2>
      <p>
        Reviuzy est un produit d'automatisation de la réputation. Il collecte les avis, rédige les brouillons de réponse, surveille les avis bidons, et pousse les données dans le moteur AiLys qui lit la récence et la variété des mots-clés comme intrants de classement. Il fonctionne comme produit jumeau de la plateforme SEO local AiLys, avec un tableau de bord séparé pour l'opérateur et une facturation unifiée à l'intérieur du compte AiLys.
      </p>
      <p>
        Reviuzy n'est pas un service de production de contenu. Il ne rédige pas d'articles de blogue. Il n'opère pas les réseaux sociaux du commerçant. Il ne fournit pas la photographie pour la fiche Google Business Profile, parce que les photos sont téléversées par le client via l'application Reviuzy pour garder la provenance propre. Reviuzy n'est pas non plus un opérateur de concours. Le client opère le concours, et Reviuzy fournit la configuration, les gabarits juridiques et les guides d'aide.
      </p>
      <p>
        Le cadrage honnête, c'est que Reviuzy est un moteur de vélocité pour la collecte et la réponse aux avis, avec une trousse jointe pour les campagnes de concours et la gestion des avis bidons. Les commerçants qui le traitent comme tel obtiennent la hausse. Ceux qui s'attendent à ce qu'il remplace un gestionnaire marketing trouvent qu'il livre moins, parce que l'étape d'approbation humaine est volontaire et reste chez l'opérateur.
      </p>
      ...
      <ul>
        ...
        <li>La page Reviuzy configurée avec le lien d'avis du GBP</li>
      ...
      <CalloutBox type="warning" translatedLabel="Attention">
        <p>Le brouillon IA est un point de départ, pas un script. Si le client copie la suggestion telle quelle et soumet, l'avis se lit comme gabarit et Google peut détecter le schéma. L'interface Reviuzy invite le client à personnaliser la suggestion avant de soumettre, avec un petit indice visuel quand le brouillon n'a pas été édité. Cet indice améliore la qualité d'avis et protège la fiche.</p>
      </CalloutBox>
      ...
      <QuickQuiz
        ...
        question="Quelle est la bonne convention pour les réponses automatisées Reviuzy sur les avis Google?"
        options={[
      ...
      <p>
        Le moteur de concours Reviuzy est le levier pour les sommets de vélocité d'avis. Un concours mensuel invite les clients à laisser un avis, avec un prix tiré parmi les inscriptions. Le tableau de bord remonte le nombre d'inscriptions, les règles d'admissibilité, la description du prix et la mécanique de tirage. La configuration prend moins de 30 minutes au premier concours et moins de 5 minutes pour les concours suivants.
      </p>
      <p>
      ...
      <p>
        La gestion des photos de gagnant suit la même séparation. Le client téléverse la photo via l'application Reviuzy, l'application capte le consentement, et la photo part au GBP via l'API officielle. AiLys ne fournit pas les photos de gagnant et ne téléverse pas au nom du concours. Cela protège le client des enjeux de droits d'auteur et garde la provenance photo propre pour Google.
      </p>
      ...
      <p>
        Chaque nouvel avis passe par le notateur d'avis bidons Reviuzy à l'arrivée. Le notateur lit quelques signaux : âge du compte, schéma d'historique d'avis, probabilité d'écriture par modèle de langage, proximité de grappe IP, et schémas de timing par rapport aux heures d'ouverture du commerce. Les avis au-dessus du seuil de signalement sont remontés dans le tableau de bord avec une action « signaler à Google » en un clic.
      </p>
      <p>
        Le système ne signale pas automatiquement sans approbation du propriétaire, parce que les faux positifs portent une pénalité. Google a resserré les règles de signalement et provoque maintenant une suppression douce des fiches qui signalent à répétition des avis légitimes. La convention Reviuzy est une décision humaine par signalement, avec l'IA qui fournit le score et le texte de justification suggéré.
      </p>
      <p>
        Le tableau de bord suit les résultats de signalement dans le temps, et le propriétaire voit quels signaux mènent à des retraits Google réussis et lesquels non. La plupart des signalements légitimes viennent de grappes de comptes neufs qui publient dans la même heure, de schémas linguistiques qui correspondent à un modèle de génération connu, et d'avis qui réfèrent à des services que le commerce n'offre pas. La plupart des signalements rejetés viennent de clients réguliers qui utilisent simplement un langage très bref.
      </p>

      <SectionDivider />

      <h2 id="comment-reviuzy-se-branche-au-gbp-et-au-moteur-ailys">Comment Reviuzy se branche au GBP et au moteur AiLys</h2>
      <p>
        Reviuzy se connecte au Google Business Profile via l'API officielle Google avec des portées de lecture et d'écriture pour les avis, les réponses, et (avec consentement du propriétaire) les téléversements de photos. La connexion est en OAuth, le jeton est stocké chiffré, et l'opérateur peut révoquer l'accès à tout moment depuis le tableau de bord. Aucun identifiant ne vit hors du coffre Reviuzy.
      </p>
      <p>
      ...
      <h2 id="quand-reviuzy-se-rentabilise">Quand Reviuzy se rentabilise</h2>
      <p>
      ...
      <KeyTakeaway
        ...
        points={[
          'Reviuzy coûte 100 dollars CAD par mois, inclus dans le palier AiLys Agency.',
          ...
          "Les photos sont téléversées par le client via l'application Reviuzy. AiLys ne fournit pas les photos de gagnant.",
      ...
      <img
        src={meta.images.end}
        alt="Carte récapitulative du module Reviuzy avec les quatre leviers et le branchement GBP pour un commerce local québécois"
        className="w-full rounded-xl my-6"
        loading="lazy"
      />
    </article>
