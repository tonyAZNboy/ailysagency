...
export function Footer() {
  ...
  const company = [
    ...
    { label: lang === "fr" ? "Audit NAP" : "NAP audit", href: "/audit/nap" },
    { label: lang === "fr" ? "Rapports d'industrie" : "Industry Reports", href: "/industry-reports" },
    { label: lang === "fr" ? "Realisations web" : "Web portfolio", href: "/realisations" },
    { label: lang === "fr" ? "Conformite Quebec" : "Quebec compliance", href: "/conformite-quebec" },
    { label: lang === "fr" ? "Garantie de performance" : "Performance guarantee", href: "/garantie" },
    { label: lang === "fr" ? "Le Pouls Local (infolettre)" : "Le Pouls Local (newsletter)", href: "/pouls-local" },
    { label: lang === "fr" ? "Concours PME 2026" : "Quebec PME Awards 2026", href: "/concours-pme" },
    { label: lang === "fr" ? "Trousse NFC" : "NFC welcome kit", href: "/trousse-nfc" },
    { label: lang === "fr" ? "Receptionniste IA" : "AI Receptionist", href: "/reception-ia" },
    { label: lang === "fr" ? "WhatsApp Business" : "WhatsApp Business", href: "/whatsapp-business" },
