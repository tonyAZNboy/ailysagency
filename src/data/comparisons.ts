...
const sterlingSky: Comparison = {
  ...
  en: {
    ...
    pricing: {
      ...
      ailysRange: "$300 to $1,299 /mo (transparent tiers, month to month)",
    ...
    seoDescription:
      "Honest comparison: AiLys Agency ($300 to $1,299/mo) vs Sterling Sky ($5,000+/mo). Both deliver classical local SEO. AiLys adds AEO, GEO, E-E-A-T optimization for ChatGPT, Perplexity, Claude, Gemini, Google AIO, Bing Copilot. Bilingual EN and FR-CA in-house. Quebec-anchored.",
    seoKeywords: [
...
/* ──────────────────────────────────────────────────────────────────────────
   COMPARISON 2 · BRIGHTLOCAL (tools-only platform, $799-$1,299/mo)
   ────────────────────────────────────────────────────────────────────────── */
...
const brightlocal: Comparison = {
  ...
  en: {
    ...
    subheadline:
      "BrightLocal is a strong tools platform for agencies running local SEO at scale. They charge $799 to $1,299/mo for the software, and you operate it. AiLys is a done-for-you service at the same price range. We run the methodology, you get the citations.",
    verdictTitle: "When AiLys is the right fit",
    verdictBody:
    ...
    pricing: {
      competitorRange: "$79 to $1,299 /mo (DIY SaaS, you operate the tools)",
      ailysRange: "$300 to $1,299 /mo (done-for-you service)",
    ...
    rows: [
      ...
      { feature: "Top tier", competitor: "$1,299 /mo (Enterprise)", ailys: "$1,299 /mo (Autopilot)", outcome: "tie" },
    ...
    seoDescription:
      "Honest comparison: AiLys Agency done-for-you ($300 to $1,299/mo) vs BrightLocal DIY tools ($79 to $1,299/mo). AiLys runs AEO, GEO, E-E-A-T optimization end to end. BrightLocal sells you the dashboard, you operate it. Bilingual EN and FR-CA delivery. Quebec-anchored.",
    seoKeywords: [
...
const localiq: Comparison = {
  ...
  en: {
    ...
    pricing: {
      ...
      ailysRange: "$300 to $1,299 /mo (service only, ad spend would be separate)",
    ...
    seoDescription:
      "Honest comparison: AiLys Agency boutique AI SEO ($300 to $1,299/mo) vs LocaliQ mass-volume digital marketing ($10 to $2,300/mo). AiLys delivers AEO, GEO, E-E-A-T with same strategist throughout. LocaliQ runs at industrial scale. Bilingual EN and FR-CA. Quebec-anchored.",
    seoKeywords: [
      "AiLys vs LocaliQ",
      "LocaliQ alternative",
      "LocaliQ pricing",
