...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  {
    slug: "reviuzy",
    term: "AiLys Automation",
    termFr: "AiLys Automation",
    category: "tooling",
    shortEn:
    ...
    longEn:
      "AiLys Automation is the internal automation platform operated by AiLys Agency (Reviuzy Inc). It is a self-serve SaaS that handles review collection, NFC tap-to-review campaigns, automated review responses (with human approval), and Google Business Profile automation.\n\nAiLys Automation can be used standalone (subscription starts at $20/mo) or bundled into the AiLys Agency tier ($2,500/mo) where AiLys handles strategy and AiLys Automation handles delivery.\n\nThe NFC tap-to-review system ships physical NFC cards or stickers to each business location. Customers tap their phone, get a 15-second guided review flow with AI assistance, and submit to Google directly. Conversion from tap to posted review is roughly 60-70% in our internal data, vs roughly 5-10% for traditional \"please leave us a review\" emails.\n\nAiLys Automation is the internal platform; the agency consulting service is the customer-facing offering. Both are operated by Reviuzy Inc dba AiLys Agency under a unified billing structure.",
    longFr:
      "AiLys Automation est le produit sœur de AiLys Agency. C'est un SaaS libre-service qui gère la collecte d'avis, les campagnes NFC tap-to-review, les réponses automatisées aux avis (avec approbation humaine) et l'automatisation du Profil Google.\n\nAiLys Automation peut être utilisé seul (abonnement à partir de 20 $/mois) ou intégré au forfait AiLys Agency (1 299 $/mois) où AiLys gère la stratégie et AiLys Automation gère la livraison.\n\nLe système NFC tap-to-review livre des cartes ou autocollants NFC physiques à chaque emplacement d'entreprise. Les clients tapent leur téléphone, obtiennent un flux d'avis guidé de 15 secondes avec assistance IA, et soumettent directement à Google. La conversion du tap à l'avis publié est d'environ 60 à 70 % dans nos données internes, vs environ 5 à 10 % pour les courriels traditionnels « laissez-nous un avis ».\n\nAiLys Automation et AiLys sont deux produits séparés avec deux structures de prix séparées. Ils partagent l'infrastructure (backend Supabase, fonctions edge) mais sont vendus et opérés indépendamment.",
