...
export const industryReports: IndustryReport[] = [
  ...
  // Q2 2026 placeholders (real data collection in progress April-June 2026)
  {
    slug: "real-estate-quebec-q2-2026",
    ...
    region: "Quebec",
    status: "coming-soon",
    title: "State of AI Visibility for Quebec Real Estate Brokers, Q2 2026",
    titleFr: "Etat de la visibilite IA des courtiers immobiliers du Quebec, T2 2026",
    excerpt:
      "Coming July 2026. Will cover ~50 Quebec real-estate brokers (residential, commercial, recreational) probed across 6 AI engines, with focus on neighborhood-level schema, OACIQ membership signals, virtual-tour adoption impact, and the listing-velocity vs reputation-velocity tradeoff.",
    excerptFr:
      "A venir en juillet 2026. Couvrira environ 50 courtiers immobiliers quebecois (residentiel, commercial, recreatif) sondes sur 6 moteurs IA, avec focus sur le schema au niveau quartier, les signaux d'adhesion OACIQ, l'impact de l'adoption des visites virtuelles, et le compromis velocite d'inscriptions vs velocite de reputation.",
    sampleSize: "Sample collection in progress (April-June 2026)",
    sampleSizeFr: "Collecte d'echantillon en cours (avril a juin 2026)",
    topMetrics: [],
    sections: [],
    takeaways: [],
  },
  {
    slug: "hotels-quebec-q2-2026",
    industry: "hotels",
    quarter: "Q2",
    year: 2026,
    publishedAt: "2026-07-15",
    region: "Quebec",
    status: "coming-soon",
    title: "State of AI Visibility for Quebec Hotels, Q2 2026",
    titleFr: "Etat de la visibilite IA des hotels du Quebec, T2 2026",
    excerpt:
      "Coming July 2026. Will cover ~40 Quebec hotels (boutique, business, resort, B&B) probed across 6 AI engines, with focus on Booking + Expedia + Airbnb cross-channel review consistency, amenity schema completeness, language capability flags, and the seasonal rate-update cadence impact on AI citations.",
    excerptFr:
      "A venir en juillet 2026. Couvrira environ 40 hotels quebecois (boutique, affaires, station, B&B) sondes sur 6 moteurs IA, avec focus sur la coherence d'avis multi-canaux Booking + Expedia + Airbnb, la completude du schema d'amenagements, les drapeaux de capacite linguistique, et l'impact de la cadence de mise a jour des tarifs saisonniers sur les citations IA.",
    sampleSize: "Sample collection in progress (April-June 2026)",
    sampleSizeFr: "Collecte d'echantillon en cours (avril a juin 2026)",
    topMetrics: [],
    sections: [],
